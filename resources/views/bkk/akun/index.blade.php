                    ...
                    <table class="myTableDataTable table table-striped table-bordered" id="html_table" width="100%">
                        ...
                        @foreach ($user as $key)
                            ...
                            <tr>
                                ...
                                <td>
                                    <button onclick="reset(this)" data-skin="dark" id="[{{ json_encode($key) }}]"  class="btn btn-outline-primary m-btn m-btn--icon m-btn--icon-only" data-toggle="m-tooltip" title="Reset Password 123456"><i class="m-menu__link-icon flaticon-refresh"></i></button>
